var picSectionCollector = [];
var vocabularySectionCollector = [];
var recallSectionCollector = [];
var recallBackwardsSectionCollector = [];
var relationshipSectionCollector = [];
var arithmeticSectionCollector = [];
...
{
   var descriptCat = "";
   if(getFullPolyScaleScore() > 90.0) descriptCat = "Average";
   if(getFullPolyScaleScore() > 110.0) descriptCat = "Bright Normal";
   if(getFullPolyScaleScore() > 120.0) descriptCat = "Superior";
   if(getFullPolyScaleScore() > 130.0) descriptCat = "Very Superior";
